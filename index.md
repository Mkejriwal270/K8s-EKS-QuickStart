...
This is also a multi-stage pipeline like the previous one, which first deletes the ingress resources including the load-balancer using helm charts and then the rest of the resources using terraform
